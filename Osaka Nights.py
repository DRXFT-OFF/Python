...
print('Приветствую! Рад видеть вас в Osaka Nights Alpha 0.1! \n'
...
prices = {'сосиски': 150, 'чипсы': 75, 'молоко': 75, 'консервы': 200, 'крупа': 100, 'лапша': 80, 'бп': 20}
sleep(0.5)
print('--------------- \nОБУЧЕНИЕ \n---------------')
...
while True:                                     # начинаем цикл покупок
    print('-' * 15)
    ans = input('сосиски(150¥) чипсы(75¥) молоко(75¥) консервы(200¥) крупа(100¥)'
                ' лапша(80¥) бп(20¥) / Enter - уйти \n').lower()
    if ans == 'сосиски':                                        # добавление продуктов в корзину и добавление цены
        numb = int(input(f'Сколько пачек купить? \n'))
        bill += numb * prices[ans]
        products['сосиски'] += numb
        print(f'Чек: {bill}')
        print(f'Продукты: \n{products}')
    elif ans == 'чипсы':
        numb = int(input(f'Сколько пачек купить? \n'))
        ...
        numb = int(input(f'Сколько пачек купить? \n'))
        bill += numb * prices[ans]
        products['молоко'] += numb
        print(f'Чек: {bill}')
        print(f'Продукты: \n{products}')
    elif ans == 'консервы':
        numb = int(input(f'Сколько пачек купить? \n'))
        bill += numb * prices[ans]
        products['консервы'] += numb
        print(f'Чек: {bill}')
        print(f'Продукты: \n{products}')
    elif ans == 'крупа':
        numb = int(input(f'Сколько пачек купить? \n'))
        ...
        if bill > stats['¥']:          # запускаем условие, если чек получился больше, чем есть в кармане
            ...
            while bill > stats['¥']:       # начинаем цикл уборки продуктов
                ...
                if ans in products:         # если название продукта есть в корзине(исключение ошибки в символе):
                    num = int(input('Сколько штук? 0 - убрать другое \n'))      # пишем сколько убрать
            ...
            cancel = input('Хотите что-то убрать? Y/N \n').capitalize()     # спрашиваем надо ли что-то убрать
            if cancel == 'Y':       # если надо убрать:
            ...
            if cancel == 'N':       # если не хотим ничего убирать
                ...
                if pay == 'N':      # если не хотим платить, то:
...
sleep(5)
end = input('Нажмите Enter, чтобы закрыть игру')
